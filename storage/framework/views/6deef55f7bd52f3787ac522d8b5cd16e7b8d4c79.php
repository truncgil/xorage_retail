...
$(".cevapla-soru").on("click",function(){
	...
	$.post("<?php echo e(url("admin-ajax/cevap-soru")); ?>",{
		soru_id : id,
...
<script type="text/javascript" src="<?php echo e(url('assets/touch.js')); ?>"></script>	
	...
	//	$("[name='Tonnage']").attr("type","text").prop("type","text").mask('#,0000', {reverse: true});
		...
		$( ".sortable" ).sortable({
			...
			stop: function(evt, ui) {
				...
				$.post("<?php echo e(url('admin-ajax/content-sort')); ?>",{
...
$(document).ready(function() {
	...
	Codebase.helpers('notify', {
		...
		message: '<?php echo __(\Session::get('mesaj')); ?>'
	...
	Codebase.helpers('notify', {
		...
		message: "<?php echo __(\Session::get('hata')); ?>"
  ...
  function trigger() {
	 ...
	 $("#modal-popin .block-content").html("<?php echo e(e2("Yükleniyor...")); ?>").load($(this).attr("href"));
...
$("#modal-popin .modal-dialog").removeClass("modal-lg"); 
 ...
 $(".modal-footer").show();
  ...
  $("[ajax]").on("click",function(){
	...
	$(yer).html("<?php echo e(e2("Yükleniyor...")); ?>").load($(this).href("href"));
  ...
  $("[data-ajax]").each(function(){
	...
	//  alert(ajax);
	  ...
	  if(ajax!="") {
		  ...
		  $(this).load("<?php echo e(e2("Loading")); ?>").load("?ajax2="+ajax); 
  ...
  */
  ...
  $(".yayinla").on("click",function(){
	...
	var bu = $(this);
	 ...
	 $.post("<?php echo e(url('admin-ajax/input-edit')); ?>",{
...
//	 Codebase.layout('header_loader_on')
	 ...
	 $(this).find(":submit").html("<?php echo e(__('İşlem yapılıyor...')); ?>").prop("disabled",true); 
...
</script><?php /**PATH /home/truncgil/happyworks.truncgil.link/resources/views/admin/inc/script.blade.php ENDPATH**/ ?>