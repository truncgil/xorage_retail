...
<link href="https://fonts.googleapis.com/css?family=Saira+Semi+Condensed:100,300,400,700,900&display=swap&subset=latin-ext" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/css/mobile.css?'.rand(1111,9999))); ?>" />
...
<script>
    function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('<?php echo trim(strip_tags($__env->yieldContent('title'))); ?>.' + (type || 'xlsx')));
        }
</script>
</div>
</head>
    ...
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-glass side-trans-enabled">
				...
				<div class="block pull-r-l">
                    ...
                    <div class="block-content"> 
						<form action="<?php echo e(url('admin?ajax=profile-update')); ?>" method="post">
							...
							<?php echo e(__('Şifre')); ?> <small><?php echo e(__('(Değiştirmek istemiyorsanız boş bırakın)')); ?></small>
								<input type="text" name="password" id="" class="form-control" value="" />
							<br />
							<button class="btn btn-primary"><?php echo e(__('Bilgilerimi Güncelle')); ?></button>
        ...
        <nav id="sidebar">
            ...
            <a class="link-effect font-w700" href="#">
                                <img id="mainLogo" width="100%" style="        max-width: 100px;" data-theme="light" src="<?php echo e(url(set_return("/logo.svg"))); ?>" class="h-full-w-auto" alt="Trunçgil Teknoloji">
                            </a>
            ...
            <div class="content-header">
                ...
                <div class="content-header-section">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="btn btn-info" onclick="window.print()"><i class="fa fa-print"></i> <?php echo e(e2("Yazdır")); ?></div>
                        <div class="btn btn-success" onclick="ExportToExcel('xlsx')"><i class="fa fa-file-excel"></i> <?php echo e(e2("Excel'e Aktar")); ?></div>
						...
						<div class="dropdown">
						  ...
						  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							...
							<a class="dropdown-item" href="<?php echo e(url('logout')); ?>">
                                <i class="si si-logout mr-5"></i> <?php echo e(__('Çıkış Yap')); ?>
					...
					<a href="<?php echo e(url('./')); ?>" target="_blank" class="btn btn-circle d-none"><i class="fa fa-globe"></i> <?php echo e(__('Siteye Dön')); ?></a>
                   <button type="button" class="btn btn-circle btn-dual-secondary" data-toggle="layout"
        ...
        <?php echo $__env->make("admin.inc.mobile-footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button  class="btn btn-alt-secondary" data-dismiss="modal"><?php echo e(__('Hayır')); ?></button>
...
</script> <?php /**PATH /home/truncgil/happyworks.truncgil.link/resources/views/admin/master.blade.php ENDPATH**/ ?>